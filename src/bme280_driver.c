...
int8_t bme280_i2c_read(uint8_t reg_addr, uint8_t *data, uint32_t len, __attribute__((unused)) void *intf_ptr){
...
int8_t bme280_i2c_write(uint8_t reg_addr, const uint8_t *data, uint32_t len, __attribute__((unused)) void *intf_ptr){
...
void bme280_delay_us(uint32_t period, __attribute__((unused)) void *intf_ptr){
    usleep(period*1000);
}
